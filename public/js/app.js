...
function updateCart(oxygen) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', oxygen).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var oxygen = JSON.parse(btn.dataset.oxygen);
    updateCart(oxygen);
  });
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkorder_system"] = self["webpackChunkorder_system"] || [];
